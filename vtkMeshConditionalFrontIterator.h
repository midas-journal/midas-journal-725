// .NAME vtkMeshConditionalFrontIterator - depth first seedgeh iterator through a vtkGraph
//
// .SECTION Description
...
class VTK_FILTERING_EXPORT vtkMeshConditionalFrontIterator : public vtkObject
{
  
public:
  static vtkMeshConditionalFrontIterator* New();
  vtkTypeRevisionMacro(vtkMeshConditionalFrontIterator, vtkObject);
